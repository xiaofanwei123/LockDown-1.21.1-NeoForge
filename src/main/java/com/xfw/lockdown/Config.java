...
public class Config {
    ...
    public static ModConfigSpec.BooleanValue enableWorldTab;
    public static ModConfigSpec.BooleanValue enableMoreTab;
    public static ModConfigSpec.BooleanValue enableMultiplayer;
    public static ModConfigSpec.BooleanValue enableSingleplayer;
    ...
    static {
        ...
        enableWorldTab = BUILDER.comment("Whether to display world settings",
                        "是否显示世界设置.")
                        .define("enable_world_tab", true);
        enableMoreTab = BUILDER.comment("Whether to display more world options",
                        "是否显示更多世界选项.")
                        .define("enable_more_tab", true);
        BUILDER.pop();

        BUILDER.push("main_menu_settings");
        enableMultiplayer = BUILDER.comment("Whether to display the multiplayer button.",
                "是否显示多人游戏按钮.").define("disable_multiplayer", true);
        enableSingleplayer = BUILDER.comment("Whether to display the single-player button.",
